...
<head>
  ...
  <meta name="description"
    content="Apptivity.id application for your acitivty.">
  <meta name="keywords"
    content="application for your acitivty">
  <meta name="author" content="Apptivity,id">
  <title>@yield('title') - Apptivity.id</title>
