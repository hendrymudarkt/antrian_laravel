...
<!-- Modal to add new poli Ends-->


<!-- Modal to edit poli starts-->
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('click', '#getEditpoli', function (e) {
            // e.preventDefault();
            id = $(this).data('id');
            $.ajax({
                url: "poli/" + id + "/edit",
        ...
        $(document).on('click', '#getDeletepoli', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            $.ajaxSetup({
                headers: {
